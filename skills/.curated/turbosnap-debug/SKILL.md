...
description: Diagnose TurboSnap behavior using logs, config, git context, and targeted trace commands. Use when you need the shared TurboSnap decision tree or want to classify why TurboSnap is enabled, disabled, unavailable, or tracing the wrong stories.
metadata:
...
- changed files plus stats file or trace output usually means `internal-after-stats`
